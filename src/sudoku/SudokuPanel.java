...
//        System.out.println(tmp);
    ...
    private boolean showCandidateHighlight() {
    	...
    	/*
    	 * isCtrlDown was originally used to do two things:
    	 * 1. toggle candidate visibility on double click
    	 * 2. toggle cell selection on single click
    	 * 
    	 * Those functions don't leave any room for showCandidateHighlight.
    	 * They conflict together, and such, I should come up with a new mechanism
    	 * to toggle their state; however, for the time being, I will simply provide
    	 * an option to keep it permanently on, or off. I find it too distracting.
    	 */
